...
# with command line options: step1 --filein file:DarkHiggs_MonoHs_LO_gensim.root --fileout file:DarkHiggs_MonoHs_LO_step1.root --pileup_input pu.root --mc --eventcontent PREMIXRAW --datatier GEN-SIM-RAW --conditions 94X_mc2017_realistic_v10 --step DIGIPREMIX_S2,DATAMIX,L1,DIGI2RAW,HLT:2e34v40 --nThreads 4 --datamix PreMix --era Run2_2017 --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 10 --python_filename aod_templateTemp.py
import FWCore.ParameterSet.Config as cms
import pu_files2017 as pu_f
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:XX-GENSIM-XX_gensim.root'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:XX-AODFILE-XX_step1.root'),
...
process.mixData.input.fileNames = cms.untracked.vstring(['root://cmsxrootd.fnal.gov/' + f for f in pu_f.mixFiles ])
