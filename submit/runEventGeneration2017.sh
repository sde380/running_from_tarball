...
cmsDriver.py step2 --filein file:${outfilename}_step1.root --fileout file:${outfilename}_aod.root --mc --eventcontent AODSIM runUnscheduled --datatier AODSIM --conditions 94X_mc2017_realistic_v10 --step RAW2DIGI,RECO,RECOSIM,EI --nThreads 2 --era Run2_2017 --python_filename ${outfilename}_2_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 500
...
#xrdcp file:///$PWD/${outfilename}_miniaod.root root://cmseos.fnal.gov//store/user/jongho/DarkHiggs/MonoDarkHiggs/year2017/mHs50/MZprime_500_Mhs_50_Mchi_150/DarkHiggs_MonoHs_LO_MZprime_500_Mhs_50_Mchi_150_${TempNumber}_miniaod.root
#xrdcp file:///$PWD/${outfilename}_miniaod.root root://cmseos.fnal.gov//store/user/jongho/DarkHiggs/MonoDarkHiggs/year2017/mHs70/MZprime_500_Mhs_70_Mchi_150/DarkHiggs_MonoHs_LO_MZprime_500_Mhs_70_Mchi_150_${TempNumber}_miniaod.root
#xrdcp file:///$PWD/${outfilename}_miniaod.root root://cmseos.fnal.gov//store/user/jongho/DarkHiggs/MonoDarkHiggs/year2017/mHs90/MZprime_500_Mhs_90_Mchi_150/DarkHiggs_MonoHs_LO_MZprime_500_Mhs_90_Mchi_150_${TempNumber}_miniaod.root
#xrdcp file:///$PWD/${outfilename}_miniaod.root root://cmseos.fnal.gov//store/user/jongho/DarkHiggs/Monojet/year2017/MZprime_500_Mchi_150/DarkHiggs_MonoJet_LO_MZprime_500_Mchi_150_${TempNumber}_miniaod.root
#xrdcp file:///$PWD/${outfilename}_miniaod.root root://cmseos.fnal.gov//store/user/jongho/DarkHiggs/MonoV/MonoW/year2017/MZprime_500_Mchi_150/DarkHiggs_MonoW_LO_MZprime_500_Mchi_150_${TempNumber}_miniaod.root
xrdcp file:///$PWD/${outfilename}_miniaod.root root://cmseos.fnal.gov//store/user/jongho/DarkHiggs/MonoV/MonoZ/year2017/MZprime_500_Mchi_150/DarkHiggs_MonoZ_LO_MZprime_500_Mchi_150_${TempNumber}_miniaod.root
echo "DONE."
